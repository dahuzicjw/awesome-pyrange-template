...
<mapper namespace="${generateInfo.mapperPackage}.${generateInfo.moduleName}Mapper">
    ...
    <insert id="insert" parameterType="${generateInfo.modelPath}.dto.${generateInfo.modelNameLowerCamel}.${generateInfo.moduleName}Po" keyProperty="${generateInfo.primaryKeyCamel}" useGeneratedKeys="true">
    ...
    <update id="update" parameterType="${generateInfo.modelPath}.dto.${generateInfo.modelNameLowerCamel}.${generateInfo.moduleName}Po">
